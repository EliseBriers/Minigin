...
std::unique_ptr<dae::BaseComponent> dae::ComponentFactory::GetComponent( GameObject& gameObject, const JsonObjectWrapper& jsonObject )
{
...
std::unique_ptr<dae::BaseComponent> dae::ComponentFactory::GetComponent( const std::string& className, GameObject& gameObject, const JsonObjectWrapper& jsonObject, std::string name )
{
